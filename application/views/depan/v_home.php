...
<head>
    ...
    <title>SMAN 1 WAY BUNGUR - Selamat Datang di SMAN 1 WAY BUNGUR</title>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        ...
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>info@sman1waybungur.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>JALAN PANGUBUAN NO 1 TIMUR, Tambah Subur, Way Bungur, Kab. Lampung Timur, Lampung 34373
                        </div>
                    </div>
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               <h2>Welcome</h2>
               <p>Kami Menyambut baik terbitnya Website SMAN 1 WAY BUNGUR yang baru , dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
                    ...
                    <p><?php echo date('Y');?> © copyright by <a href="http://sman1waybungur.com" target="_blank">SMAN 1 WAY BUNGUR</a>. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span>JALAN PANGUBUAN NO 1 TIMUR, Tambah Subur, Way Bungur, Kab.Lampung Timur, Lampung 34373</p>
                        <p>Email : info@sman1waybungur.com
